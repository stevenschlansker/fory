...
public class Encoders {
   ...
   * generated class lives next to the interface as {@code <Interface>_Fory}; this helper hides
   * the naming convention so a {@code @ForyGenerate} interface can declare
   *
   * <pre>{@code
   ...
   *
   * @throws IllegalStateException if the generated factory is not on the classpath of
   *     {@code ifaceClass} — typically because the {@code @ForyGenerate} annotation processor
   *     has not been wired into the build that produced {@code ifaceClass}.
   */
  public static <T> T factory(Class<T> ifaceClass) {
    ...
    try {
      ...
      throw new IllegalStateException(
          "Failed to invoke " + generated + ".instance()", e);
    }
  }
