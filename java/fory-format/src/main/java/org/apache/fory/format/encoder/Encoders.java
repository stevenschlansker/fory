...
public class Encoders {
   ...
   * generated class lives next to the interface as {@code <Interface>_Fory}; this helper hides the
   * naming convention so a {@code @ForyGenerate} interface can declare
   *
   * <pre>{@code
   * MyCodecs INSTANCE = Encoders.factory(MyCodecs.class);
   * }</pre>
   *
   * <p>Callers see a normal-looking singleton without having to know or type the generated class
   * name.
   *
  ...
  public static <T> T factory(Class<T> ifaceClass) {
    ...
    String pkg = CodeGenerator.getPackage(ifaceClass);
