 ...
 * RowCodecs.factory(...)} so callers do not have to know the generated class name:
 *
 * <pre>{@code
 ...
 * {@code RowCodecs.factory(MyCodecs.class)} derives that name and returns its singleton.
 */
